...
# Plot the responses
plt.figure()
plt.plot(t_ol, y_open_loop, label="Open Loop Response")
plt.plot(t_cl_p5, y_setpoint_p5, label="$K_p = 0.5$")
plt.plot(t_cl_1, y_setpoint_1, label="$K_p = 1$")
plt.plot(t_cl_4, y_setpoint_4, label="$K_p = 4$")
plt.xlabel('Time')
plt.ylabel('$y(t)$')
plt.legend()
plt.show()
