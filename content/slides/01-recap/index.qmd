...
# Plot the root on the complex plane
plt.figure()
plt.plot(np.real(root), np.imag(root), 'x')
plt.title('Roots of a first order system')
plt.xlabel('Real')
...
# Calculate the square root of -4 using cmath
root = cmath.sqrt(-4)
print("The square root of -4 is: ", root)

# Plot the root on the complex plane
plt.figure()
plt.plot(root.real, root.imag, 'x', label='root')
plt.title('Square root of -4 on the complex plane')
plt.xlabel('Real')
plt.ylabel('Imaginary')
plt.legend()
plt.grid(True)
...
# Define the system parameters
zeros = [1, -2]  # zeros of the system
poles = [-1, 2]  # poles of the system
...
plt.title('Poles and zeros of a complex transfer function')
plt.xlabel('Real')
plt.ylabel('Imaginary')
plt.legend()
plt.grid(True)
