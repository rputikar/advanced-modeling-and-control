...
In practice, the measured variables may have bias, drift, or mismatch. A
trim factor (bias or small corrective feedback) is added to the ratio
station to compensate for such deviations.

* Example: $u = R \cdot d + b$, where $b$ is the trim signal.
