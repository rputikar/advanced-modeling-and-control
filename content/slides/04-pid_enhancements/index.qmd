...
![](../../../assets/images/04-PID-enhancements-tank-with-pump.png){width=90%}
...
![](../../../assets/images/04-PID-enhancements-tank-with-pump-level-control.png){width=90%}
...
![](../../../assets/images/04-PID-enhancements-vapor-liquid-separator.png){width=90%}
:::
::::
...
![](../../../assets/images/04-PID-enhancements-vapor-liquid-separator-at-control.png){width=90%}
:::
::::

## Environmental protection

![](../../../assets/images/04-PID-enhancements-vapor-liquid-separator-complete-control.png){width=60%}
...
![](../../../assets/images/04-PID-enhancements-distillation-column.png){width=90%}
...
![](../../../assets/images/04-PID-enhancements-vapor-liquid-separator-complete-control.png){width=50%}
...
# Closed-loop response for Gp = 1/((5s+1)(3s+1)) with PI (Kc=2, tauI=6)
# Step setpoint starts at t = 1 s
# Compare no-delay vs delays of 1 s and 2 s
...
# --- Helper: Closed loop with given delay ---
def closed_loop_with_delay(Gp, delay, pade_order=4):
    if delay > 0:
        num_d, den_d = ctrl.pade(delay, pade_order)
        Gp = Gp * ctrl.tf(num_d, den_d)
    return ctrl.feedback(Gc*Gp, 1)

# Systems: no delay, 1s delay, 2s delay
Gcl0 = closed_loop_with_delay(Gp, 0)
Gcl1 = closed_loop_with_delay(Gp, 1.0)
Gcl2 = closed_loop_with_delay(Gp, 2.0)

# --- Simulation with delayed step ---
t = np.linspace(0, 60, 3000)
t_step = 1.0
r = (t >= t_step).astype(float)

def simulate(Gcl, t, r):
    resp = ctrl.forced_response(Gcl, T=t, U=r)
...
t0, y0 = simulate(Gcl0, t, r)
t1, y1 = simulate(Gcl1, t, r)
t2, y2 = simulate(Gcl2, t, r)

# --- Plot ---
fig, ax = plt.subplots()
ax.plot(t, r, 'k--', label="setpoint")
ax.plot(t0, y0, label="no delay")
ax.plot(t1, y1, label="1 s delay")
ax.plot(t2, y2, label="2 s delay")
...
fig.tight_layout()
fig.savefig("effect-of-deadtime.svg", format="svg")
plt.close(fig)

```
![](./effect-of-deadtime.svg){width=70%}
...
![](../../../assets/images/04-PID-enhancements-inferential-temperature-control-distillation-column.png){width=90%}
...
![](../../../assets/images/04-PID-enhancements-tray-temp-location.png){width=90%}
...
![](../../../assets/images/04-PID-enhancements-comp-temp-correlation.png){width=90%}
...
:::{.pad100}
![](../../../assets/images/04-PID-enhancements-feedback-correction-feed-composition-change.png){width=50%}
:::
...
![](../../../assets/images/04-PID-enhancements-packed-bed-reactor.png){width=40%}
...
:::{.pad100}
![](../../../assets/images/04-PID-enhancements-polymer-mwd.png){width=90%}
:::
...
![](../../../assets/images/04-PID-enhancements-heat-exchanger-control.png){width=90%}


![Open-Loop response for a heat exchanger for different feed
rates.](../../../assets/images/04-PID-enhancements-heat-exchanger-open-loop-response.png){width=90%}
...
![](../../../assets/images/04-PID-enhancements-heat-exchanger-control-response.png){width=90%}
...
![](../../../assets/images/04-PID-enhancements-furnace-tube-temp-control.png){width=90%}
...
flow](../../../assets/images/04-PID-enhancements-column-flooding-constraint-control.png){width=90%
.pad}
...
flow](../../../assets/images/04-PID-enhancements-controlling-multiple-constraints.png){width=90%}
...
![](../../../assets/images/04-PID-enhancements-hotspot-temp-control.png){width=90% .pad}
...
![](../../../assets/images/04-PID-enhancements-cross-limit-firing-control.png){width=90% .pad}


## Firing rate increase

![](../../../assets/images/04-PID-enhancements-cross-limit-firing-control-rate-increase.png){width=90% .pad}
...
![](../../../assets/images/04-PID-enhancements-cross-limit-firing-control-rate-decrease.png){width=90% .pad}
...
![](../../../assets/images/04-PID-enhancements-override-control.png){width=90% .pad}
