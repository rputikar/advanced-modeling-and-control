...
### Implicit and explicit control objectives
Both implicit and explicit control objectives refer to the desired outcomes or
goals for a system's performance. They provide the framework for designing and
...
Control involves adjusting an input variable to
maintain an output variable at a desired value. This is accomplished using a
control strategy, which continually measures the output, compares it with the
desired value, and adjusts the input to minimize the difference or error
between the desired value and output. Control is a dynamic process that occurs
in real time. It's primarily concerned with maintaining stability, reducing
variability, and reacting to disturbances in the system.
...
![Optimal plant operations](../../../assets/images/01-recap-fig3-optimal-plant-operations.png){#fig-optimal-plant-operations width=60%}
...
![Hirarchy of process control activities](../../../assets/images/01-recap-time-scales-of-process-control-activities.png){#fig-control-activity-hirarchy width=60%}
...
development.](../../../assets/images/major-steps-control-system-developement.png){#fig-major-steps width=60%}
...
![Creating a hybrid model](../../../assets/images/hybrid_models.png){#fig-hybrid-models width=60%}
...
![Stirred tank blending process](../../../assets/images/blending-example.png){#fig-stirred-tank-blending width=60%}
