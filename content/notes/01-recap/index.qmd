...
:::{.grid} ::: {.g-col-5} [Lecture
resources](../../lectures/01-recap/index.qmd){.btn .btn-success .btn-lg
role="button"} ::: :::
...
```{python}
#| label: fig-fopdt-response
#| fig-cap: FOPTD Step Response
...
# plt.axhline(y_632, color='#65489d', linestyle='--')
# plt.axvline(t_632, color='#65489d', linestyle='--')

# plt.axhline(y_t_by_tau_5, color='#65489d', linestyle='--')
# plt.axvline(t_by_tau_5, color='#65489d', linestyle='--')

plt.plot([0, t_632], [y_632, y_632], color='#65489d', linestyle='--')
plt.plot([t_632, t_632], [0, y_632], color='#65489d', linestyle='--')

plt.plot([0, t_by_tau_5], [y_t_by_tau_5, y_t_by_tau_5], color='#65489d', linestyle='--')
plt.plot([t_by_tau_5, t_by_tau_5], [0, y_t_by_tau_5], color='#65489d', linestyle='--')
