...
2. Methodology and Implementation
   ...
   * Explain PID tuning and derivation of the feedforward controller (idealized method).
...
4. Analysis and Discussion
   ...
   * Compare and interpret the performance of the two strategies.
   * Discuss:

     * Improvement due to feedforward
     * Impact of ±10% model mismatch
     * Which feedforward design (idealized vs. unified) might perform better
...
|-|-|-|-|
| 1.| Objectives & Problem| 2| Clarity of problem definition and articulation of objectives|
