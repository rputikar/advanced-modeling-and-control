...
Load `iddata2` in Matlab command line using command `load iddata2`. This will
load data `z2` in workspace. 
...
Use first 200 points of `z2`(`z2(1:200)`) for model estimation and last 200
points of `z2` (`z2(201:400)`) for model prediction (testing).  
